...
class StorePosOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.menu_item_size_id' => ['nullable', 'integer', 'exists:menu_item_sizes,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.menu_item_size_id.integer' => 'Menu item size ID must be a number',
            'items.*.menu_item_size_id.exists' => 'Invalid menu item size',
